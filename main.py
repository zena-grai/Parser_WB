...
# obj = ParserWB(url)
# obj.main()
# print("Выгрузка аккумуляторов для ибп завершена!")
...
obj = ParserWB(url)
obj.main()
print("Выгрузка элементов питания завершена!")
...
obj = ParserWB(url)
obj.main()
print("Выгрузка аккумуляторов для мотоциклов завершена!")
...
obj = ParserWB(url)
obj.main()
print("Выгрузка моторного масла завершена!")

end = datetime.datetime.now()
total = end - start
print(f"\nЗатраченное время: {str(total)}")
